...
This README explains the steps in the analysis file.
•	Step 0: load all data
•	Step 1: Merges the training and the test sets to create one data set. - Test and training datasets, subject ids and activity numbers are merged to obtain a single data set. 
